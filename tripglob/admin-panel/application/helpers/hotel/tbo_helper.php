...
function set_credentials($api) {
    ...
    function tbo_hotel_cancel($data,$api_id)
    {
        ...
        $changeRequestURL  = 'http://api.tektravels.com/BookingEngineService_Hotel/hotelservice.svc/rest/SendChangeRequest';
        ...
        /*=============== get cancel request status===============*/
            ...
            if($SendChangeRequest_response['HotelChangeRequestResult']['ResponseStatus'] == 1 && !empty($SendChangeRequest_response['HotelChangeRequestResult']['ChangeRequestId']))
            {
                $data_arr['BookingMode'] = 5;
                $data_arr['ChangeRequestId'] = $SendChangeRequest_response['HotelChangeRequestResult']['ChangeRequestId'];
                ...
                $GetChangeRequestStatus_url  = 'http://api.tektravels.com/BookingEngineService_Hotel/hotelservice.svc/rest/GetChangeRequestStatus/';
                ...
                if($SendChangeRequest_response['HotelChangeRequestResult']['ResponseStatus'] == 1)
                {
                     $updateRes['status']  = true;
                     $updateRes['service_charge']  = json_encode($SendChangeRequest_response['HotelChangeRequestResult']['TotalServiceCharge']);
                     $updateRes['cancellation_charge']  = json_encode($SendChangeRequest_response['HotelChangeRequestResult']['CancellationChargeBreakUp']);
