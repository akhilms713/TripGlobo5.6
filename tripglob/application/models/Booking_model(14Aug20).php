...
public function get_xml_log_id($xml_log_id){
 ...
 public function check_promocode($promo_code){
        ...
        $query = "select p.*,a.*,a.airline_code as booking_airline_code from promo as p left join airline_list as a on p.airline_code = a.airline_list_id where p.status='ACTIVE' and p.promo_code='".$promo_code."'";
