...
class Promo_model extends CI_Model {
 ...
 function update_promo_status($id,$status)
    ...
    function add_promo_new_amount($user_id,$user_type,$discount,$promo_code,$exp_date,$promo_amount,$description,$minimum_amount,$airline_code,$module_type,$pic_name1)
   {
    ...
    function add_promo_new($user_id,$user_type,$discount,$promo_code,$exp_date,$description,$minimum_amount,$airline_code,$module_type,$pic_name, $promo_image_b2c='', $promo_image_b2b='')
   {
	   	$data = array(
	   	'user_type' => $user_type,
	   	'user_id' => $user_id,
