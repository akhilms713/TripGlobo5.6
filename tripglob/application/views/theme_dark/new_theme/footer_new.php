   ...
   <div class="container">
      ...
      <div class="col-sm-3 col-xs-12 ft_custom margin-top-xs">
        ...
        <!-- <span class="foot_phone"><i class="fa fa-phone"></i> <span class="new_footer_aligmnt"></span></span>-->
         ...
         <span class="foot_phone"><i class="fa fa-users"></i><span class="new_footer_aligmnt"><a href="https://tripglobo.com/account/agent_registration">Become An Agent</a></span></span>
