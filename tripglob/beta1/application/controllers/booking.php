         ...
         if($module == 'FLIGHT'){
		  ...
		  if($module == 'HOTEL'){
            ...
            if(isset($c_fname) && is_array($c_fname))
            {
               ...
               //debug($booking_passenger_v);exit("3138");
...
*/
  ...
  return $id;
	...
	public function invoice($pnr_no='',$product_id=''){
	   ...
	   //    // $datas=$this->db->where('user_id',$c_user_id)->get('user_details')->row();
	   //    // $datas = $this->booking_model->getpassengerDetail($c_user_id)->row();
	   //    // debug($datas);exit;
	   //     if($c_user_type=='1')
	   //     {
	   //           $datas['Booking']= $this->booking_model->getpassengerDetail($c_user_id,$c_user_type)->row();
	   //           $pnr_no = base64_decode(base64_decode($pnr_no));
	            ...
	            if($b_data->product_id == '1'){
					  if ($this->session->userdata('user_id')) {
						...
						if($c_user_id!='' && $c_user_type!='' && $b_data->user_id == $c_user_id && $b_data->user_type_id == $c_user_type)
						{
						  ...
						  $data['Booking'] = $booking = $this->booking_model->getBookingbyPnr($b_data->pnr_no,$b_data->product_id)->row();
						 //  debug($data);exit;
