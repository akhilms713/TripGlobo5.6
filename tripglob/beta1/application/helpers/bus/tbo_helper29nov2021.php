 ...
 if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    function set_credentials() {
      ...
      /*  if ($query->num_rows() == 0) {
            ...
            $data['UserName']          = 'IXCT029';

            $data['Password']            = 'Trip@#Trvl/898';            
    ...
    function HoldSeatsForSchedule_request($params) {
       ...
       /* debug($params['checkout_form']['bgender']);
    ...
    //$route_schedule_id, $journey_date, $route_code, $ResultToken, 

    function get_bus_details($EndUserIp, $resultIndex, $traceId, $tokenId,  $module, $module_type='B2B') {
...
error_reporting(E_ALL);*/
     ...
     */
     ...
     function format_search_response($search_result,  $search_id, $module,$module_type='B2B') {
