...
/*
 * pass date string and function converts to timestamp and return date in friendly format in 24hr format
 */
function app_friendly_datetime_24format($db_datetime)
{
	$db_datetime = strtotime($db_datetime);
	if ($db_datetime > 0) {
		return date('d-M H:i ', $db_datetime);
	}
}
