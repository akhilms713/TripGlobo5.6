...
//exit("ram");
       ...
       // debug();exit("RAHUL");
        ...
        $response['response'] = get_json_response($request_data['searchUrl'],$request_data['reqData'],$api_id,$xml_title);
    ...
    function tbo_hotel_info($search_id,$hotel_details,$PublishedPrice){
            ...
            $response['response']   = get_json_response($requestUrl,$hotel_details_req,$api_id,$xml_title);
            ...
            $roomResponse_a['response']  = get_json_response($requestUrl_a,$logs_request['request'],$api_id,$xml_title_a);
    ...
    function tbo_room_list($search_id,$roomReq,$HotelName,$api_id){
        ...
        $response['response']       = get_json_response($requestUrl,$roomReq,$api_id,$xml_title);
    ...
    function tbo_room_blocking($search_id,$NoOfRooms,$RoomIndex,$RoomTypeCode,$RoomTypeName,$RatePlanCode,$SmokingPreference,$HotelName,$roomRequest,$api_id)
    {
       ...
       // $BlockRoomUrl = 'http://api.tektravels.com/BookingEngineService_Hotel/hotelservice.svc/rest/BlockRoom';
        $BlockRoomUrl = 'http://api.tektravels.com/BookingEngineService_Hotel/hotelservice.svc/rest/BlockRoom';
        $blockRoomResponse['response'] = get_json_response($BlockRoomUrl,$blockRoomReq,$api_id,$xml_title);
    ...
    function TBO_final_booking($booking_id,$search_id,$getPaxDetails,$getBlockReq)
    {
     ...
     for ($i=0; $i < $roomCount; $i++) {
       ...
       // echo '<pre>';print_r($bookReq);exit();
        
        $bookRequest = json_encode($bookReq);
        
        // echo "<pre/>";print_r($bookRequest);die;
       ...
       // $BookRoomUrl                = 'http://api.tektravels.com/BookingEngineService_Hotel/hotelservice.svc/rest/Book';
        $BookRoomUrl = 'http://api.tektravels.com/BookingEngineService_Hotel/hotelservice.svc/rest/Book';
        $bookRoomResponse['response'] = get_json_response($BookRoomUrl,$bookRequest,$api_id,$xml_title);
