 ...
 <?php for($s=0;$s<count($segment_data);$s++){ 
        ...
        ?>
                        <div class="col-xs-12 ways_one nopad">
                            <div class="inboundiv nopad">
                                <div class="hedtowr destination_heading">
                                     <?php echo $this->Flight_model->get_airport_name($segment_data[$s]->locationIdDeparture[0]); ?> <span class="fa fa-exchange"></span>  <?php echo $this->Flight_Model->get_airport_name($segment_data[$s]->locationIdArival[$no]); ?>
                                </div>
                                    ...
                                    <div class="col-xs-1 nopad5 width_hundred">
                                      ...
                                      <div class="col-xs-2 nopad5 width_hundred">
                                        <div class="flitsmdets" style="overflow:visible;">
                                            <?php echo $segment_data[$s]->airlineName[$ss]; ?> -  <strong> <?php echo $segment_data[$s]->flightOrtrainNumber[$ss]; ?>
                      ...
                      <div class="waymensn">
                        <div class="detail_section">
                          ...
                          <div class="col-xs-4 padflt widfty">
                            <span class="timlbl " style="text-align: center;">
                              <p class="flname" style="color: #18385f;font-weight: bold;display: block;"><?php echo $segment_data[$s]->locationIdDeparture[$ss]; ?></p> 
                              <span class="fltime" style="text-align: center; font-size: 16px;"><?php echo $segment_data[$s]->DepartureTime[$ss]; ?></span>
                            </span>
                            <div class="clearfix"></div>
                                                        <div class="clearfix"></div>
                            <span class="flitrlbl elipsetool" style="text-align: center;"><?php echo date("M d,Y", strtotime($segment_data[$s]->DepartureDate[$ss]));  ?> </span>
                          </div>
                        ...
                        <div class="col-xs-4 padflt widfty">
                          <span class="timlbl " style="text-align: center;">
                            <p class="flname" style="color: #18385f;font-weight: bold;display: block;"><?php echo $segment_data[$s]->locationIdArival[$ss]; ?> </p><span class="fltime" style="    font-size: 16px;"><?php echo $segment_data[$s]->ArrivalTime[$ss]; ?></span> 
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td valign="middle" align="right">
                              <b style="font-size:15px;color:#18385f;">Amount ($)</b>
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td valign="middle" align="left"> Base Fare</td>
                           <td> &nbsp;</td>
                           <td valign="middle" align="right"> <?=$this->display_icon?> <?=number_format(($PricingDetails_ama[0]['PriceInfo']['PassengerFare'][$key]['count'] * $PricingDetails_ama[0]['PriceInfo']['PassengerFare'][$key]['totalFareAmount'] * $this->curr_val), 2)?></td>
                        </tr>
                        <?php } ?>
                        <?php } ?>
                        <tr>
