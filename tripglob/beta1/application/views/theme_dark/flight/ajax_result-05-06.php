   ...
   <div class="madgrid">
      ...
      <div class="mrinfrmtn <?=$hide_class?>">
         <div class="accordion" id="accordion<?=$flight_result[$i]['flight_id'];?>" role="tablist" aria-multiselectable="true">
            <!-- <a class="detailsflt" data-toggle="modal" onclick="show_flightpopup('<?php echo  $flight_result[$i]['flight_id'];  ?>', 'itenerary')" data-target="#flight_res"> <span class="sprite"></span> <i class="fal fa-info-circle"></i> Flight Details</a>-->
