                                    ...
                                    <tbody>
                                        ...
                                        foreach($work_data as $data)
                                        {
                                           ...
                                           <tr class="even pointer">
                                            ...
                                            <td class=""> <?php echo $data->contact_number; ?></td>
                                            <td class=""> <?php echo $data->qualification; ?></td>
                                            <td class=""> <?php echo $data->experience; ?></td>
                                            <td class=""> <?php echo $data->about_yourself; ?></td>
                                            <td><a target="_blank" href="<?php echo WEB_FRONT_URL; ?>uploads/customer_resume/<?php echo $data->resume; ?>"><i class="fa fa-file" aria-hidden="true"></i></a></td>
